...
import { ventasConfigService, type VentasPipelineStageDTO } from '../services/ventasConfig.service'
import { PIPELINE_STAGE_OPTIONS, pipelineStageLabel } from '../../ventas-sales/constants/pipeline'
