...
import { ventasSalesService } from '../../ventas-sales/services/ventasSales.service'
import type { DocumentationCostRow } from '../services/ventasFinanzas.service'
import {
...
async function openNewModal() {
  const closings = await ventasSalesService.listClosings({ page: 1, limit: 500 })
