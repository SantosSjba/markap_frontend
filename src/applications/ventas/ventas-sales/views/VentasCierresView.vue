...
import { useVentasClosingsList, useVentasCreateClosing } from '../composables/useVentasSales'
import type { SaleClosingRow } from '../services/ventasSales.service'
...
import { PAYMENT_TYPE_OPTIONS } from '../constants/pipeline'
