...
import { useVentasSeparationsList, useVentasCreateSeparation } from '../composables/useVentasSales'
import type { SaleSeparationRow } from '../services/ventasSales.service'
...
import { SEPARATION_STATUS_OPTIONS, separationStatusLabel } from '../constants/pipeline'
