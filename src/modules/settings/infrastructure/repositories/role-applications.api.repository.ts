...
import type { RoleApplicationsRepository } from '../../domain/repositories/role-applications.repository'

export const roleApplicationsApiRepository: RoleApplicationsRepository = {
