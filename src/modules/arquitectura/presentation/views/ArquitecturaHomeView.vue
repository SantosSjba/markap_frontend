...
function currentMonthRange(): ArquitecturaReportesRangeParams {
  const end = new Date()
...
const rangeParams = ref<ArquitecturaReportesRangeParams>(currentMonthRange())
...
const acciones = [
  {
    ...
    sub: 'Crear proyecto',
    to: `${ARQUITECTURA_BASE_PATH}/proyectos/nuevo`,
  ...
  },
  {
    label: 'Catálogo',
    sub: 'Ver materiales',
    to: `${ARQUITECTURA_BASE_PATH}/materiales/catalogo`,
    icon: 'lucide:layers' as const,
  },
  {
    label: 'Cronograma',
    sub: 'Ver cronograma',
    to: `${ARQUITECTURA_BASE_PATH}/cronograma`,
    icon: 'lucide:calendar-range' as const,
  },
]

function goReportes() {
  router.push({ name: 'arquitectura-reportes' })
}
