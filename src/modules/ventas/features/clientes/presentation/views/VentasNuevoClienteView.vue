  ...
  <div class="px-3 sm:px-5 py-6 sm:py-8 max-w-[1600px] mx-auto">
    ...
    <form v-else @submit.prevent="onSubmit" class="space-y-8">
      <FormSectionCard
        ...
        subtitle="Igual que en Alquileres: propietario lleva dirección fiscal; comprador lleva embudo de ventas."
        icon="lucide:users"
      >
      ...
      <FormSectionCard
        ...
        subtitle="Misma lógica que propietarios en Alquileres (ubigeo + dirección)."
        icon="lucide:map-pin"
      >
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormInput
      ...
      <div class="flex justify-end gap-3">
        ...
        <BaseButton type="submit" icon="lucide:save" :loading="createMutation.isPending.value" variant="primary">
          Guardar
        </BaseButton>
      </div>
    </form>
