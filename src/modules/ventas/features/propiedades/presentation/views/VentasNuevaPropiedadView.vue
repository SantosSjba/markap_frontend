...
const createMutation = useVentasCreateProperty()
...
watch(
  () => ownerRows.value[0],
  (id) => {
    if (id) setFieldValue('ownerId', id)
  },
)
...
const goToNewOwner = () => {
  router.push({
    ...
    query: { clientType: 'OWNER', returnTo: '/ventas/propiedades/nueva' },
  })
}
      ...
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2">
          ...
          <h1 class="text-xl font-bold" :style="{ color: 'var(--color-text-primary)' }">
            Nueva propiedad (venta)
          </h1>
        </div>
        <p class="text-sm mt-0.5" :style="{ color: 'var(--color-text-secondary)' }">
          Registro en inventario Ventas
        </p>
      </div>
    </div>
      ...
      <div class="xl:col-span-2 space-y-5">
        ...
        >
          <div class="flex items-center gap-2 mb-4">
            ...
            <div>
              <h2 class="text-base font-semibold" :style="{ color: 'var(--color-text-primary)' }">Datos del inmueble</h2>
              <p class="text-xs" :style="{ color: 'var(--color-text-muted)' }">Código, tipo y ubicación</p>
            </div>
          </div>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <FormInput
              ...
              placeholder="Urbanización / edificio"
          ...
          <FormTextarea
            ...
            class="mt-4"
            label="Descripción"
            placeholder="Detalle del inmueble..."
            :rows="3"
          />
        </section>
        ...
        >
          <div class="flex items-center gap-2 mb-4">
            ...
            <h2 class="text-base font-semibold" :style="{ color: 'var(--color-text-primary)' }">
              Multimedia (fotos y planos)
            </h2>
          </div>
          <p class="text-xs mb-3" :style="{ color: 'var(--color-text-muted)' }">
            Añade URLs públicas (almacenamiento o CDN). Puedes dejar filas vacías.
          </p>
        ...
        >
          ...
          <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <FormInput v-bind="ageYearsBinds" type="number" min="0" label="Antigüedad (años)" :error="errors.ageYears" />
            <FormInput v-bind="floorLevelBinds" label="Piso / nivel" :error="errors.floorLevel" />
            <FormInput
        ...
        >
          ...
          <p class="text-xs mb-3" :style="{ color: 'var(--color-text-muted)' }">
            Puede registrar varios copropietarios (cónyuges, herederos, etc.). El primero es el propietario principal.
          </p>
          <div
        ...
        <section
          ...
          :style="{ backgroundColor: 'var(--color-surface)', border: '1px solid var(--color-border)' }"
        >
          <h2 class="text-base font-semibold mb-4" :style="{ color: 'var(--color-text-primary)' }">Partidas (opcional)</h2>
      ...
      <div class="xl:col-span-1">
        ...
        >
          ...
          <dl class="space-y-2 text-sm">
            ...
            <div>
              <dt class="text-xs" :style="{ color: 'var(--color-text-muted)' }">Precio</dt>
