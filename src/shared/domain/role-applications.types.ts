/**
 * Reglas de acceso por rol a aplicaciones (documentación y validación en front).
 * La fuente de verdad de permisos es el backend (/applications/me); esto sirve
 * para tipos, guards o filtros locales.
 */
...
/**
 * Dada una lista de códigos de rol del usuario, devuelve los slugs de aplicaciones
